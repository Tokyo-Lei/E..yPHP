...
class Paginator
{
    ...
    /**
     * @param int $totalItems The total number of items. 分页总数
     * @param int $itemsPerPage The number of items per page. 每页的数
     * @param int $currentPage The current page number.当前页码
