...
<div class="content-inner">
    ...
    <header class="page-header">
        <div class="container-fluid">
            <h2 class="no-margin-bottom">管理碎片</h2>
        </div>
    </header>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal"  method="post" action="<?php echo $App_URL ?>Processing.php">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="f_title" value="<?php echo $fragment_db[0]['title'] ?>">
                                    </div>
                                </div>
                                <div class="line"></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="f_tag" value="<?php echo $fragment_db[0]['tag'] ?>">
                                    </div>
                                </div>
                                <div class="line"></div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="f_text" value="<?php echo $fragment_db[0]['text'] ?>">
                                    </div>
                                </div>
                                <div class="line"></div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4 form-control-label">
                                        <input type="hidden" name="f_id" value="<?php echo $fragment_db[0]['id'] ?>">
                                        <button type="submit" name="fragment_edit" class="btn btn-success" >更新</button>
                                    </div>
                                </div>
                            </form>
                        </div>
